...
{
  setupDMDAtNowForLifeTime(false, DMD_DATA_FREE_INDEX, DMD_TYPE_SCROLL_STATIC, str_date_full, false, info, true, Arial_Black_16, 1000, 10000, msDistanceFromNowToTime(23, 59, 0));
